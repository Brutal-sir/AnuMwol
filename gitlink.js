...
Asena.addCommand({pattern: 'git', fromMe: false, desc: "*Shows bot info*" }, (async (message, match) => {
  ...
  r_text[0] = "https://i.imgur.com/WSAIOnR.jpeg";
    ...
    await message.sendMessage(Buffer.from(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: `*•━━━━╼⤏Anu-mwol⤎╾━━━•*
 
        *ɢɪᴛʜᴜʙ ʟɪɴᴋ        https://github.com/Brutal-sir/Anu-mwol
