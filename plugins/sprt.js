...
Asena.addCommand({pattern: 'anu', fromMe: false,dontAddCommandList: true}, (async (message, match) => {

    var r_text = new Array ();    
r_text[0] = "\nEda eda, mandankonappi.. Nee enne kooduthal mandan aakkatheda\n";
r_text[1] = "Brutaline tholpikkaan ningalkavilla. Jeevitathil Brutaline tholpichittundu… palarum… palavattom…😥😥 aarellum aaa sed bgm onn iduo...";
r_text[2] = "Anu says i love you 😘";
r_text[3] = "Anumwolde yudhangal Company Kanan Povunnatheyuloo";
r_text[4] = "hi, how are you";
r_text[5] = "ennikk korch rest theroo...🥵🥵";
r_text[6] = "Anumwol - eva - simsim \ningane ethra ethra paerugal aan alle enikk..😂🤣";
...
r_text[8] = "\n enne vilicho...?🧐 \n";
r_text[9] = "ente per Anuz ,ninte per donkey, backi ellarum monkey😼😼";
r_text[10] = "nee vilicha enikk villi kelkathe irrikkaan pattuo";
r_text[11] = "do you know who is my creator..? its none other than Brutalsir";
...
r_text[18] = "enikk njan und Brutal uyir";
...
r_text[21] = "Kochi pazhaya kochiyellennariyam… pakshe Brutal pazhaya Brutal thanneya...😎\n\n";
r_text[22] = "Kaanaan oru look illanney ullu… bhayankara budhiya\n\n ninnak allatto enik Brutalin";
r_text[23] = "Ithalla ithinapparam chaadi kadannavananee K.K. Lalu";
